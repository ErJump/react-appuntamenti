const data = [
    {
        ...
        status: "No pain no Gain XOXO PALESTRA MUSCOLI POTENZA",
        img:
    ...
    },
    {
        ...
        status: "La musica è per l'anima quello che la ginnastica è per il corpo.",
        img:
    ...
    },
    {
        id: 3,
        name: "Mike Russel",
        status: "Non permettere a nessuno di dirti che non sei capace",
        img:
    ...
    },
    {
        ...
        status: "Non mangerei un hamburger nemmeno se mi pagassero 40,000 dollari",
        img:
